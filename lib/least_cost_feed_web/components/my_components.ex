defmodule LeastCostFeedWeb.MyComponents do
  ...
  def table(assigns) do
    ...
    ~H"""
    <div class="flex flex-row font-bold bg-blue-400 text-center border-y border-blue-800 p-2 text-l">
      <div :for={col <- @col} class={[col[:class], col[:h_class]]}><%= col[:label] %></div>
    </div>
    ...
    >
      <div
        ...
        class="flex flex-row text-center hover:cursor-pointer hover:bg-amber-300 p-1 border-b border-gray-600 bg-amber-200"
      >
